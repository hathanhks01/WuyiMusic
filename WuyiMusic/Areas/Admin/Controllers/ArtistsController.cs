...
namespace WuyiMusic.Areas.Admin.Controllers
{
    ...
    public class ArtistsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            string url = "https://localhost:7178/api/Artists/get-all";
            ...
            {
                string url = $"https://localhost:7178/api/Artists/get-by-id?id={id}";
                var reponse = await _httpClient.GetStringAsync(url);
            ...
            {
            ViewData["AlbumId"] = new SelectList(_context.Artists, "ArtistId", "CoverImage");
            string url = $"https://localhost:7178/api/Artists/create";
