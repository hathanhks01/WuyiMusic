...
namespace WuyiMusic.Areas.Admin.Controllers
{
    ...
    public class UserFollowArtistsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            string url = "https://localhost:7178/api/UserFollowArtists/get-all";
        ...
        public async Task<IActionResult> Create([Bind("UserId,ArtistId,FollowedAt")] UserFollowArtist userFollowArtist)
        {
            ViewData["ArtistId"] = new SelectList(_context.Artists, "ArtistId", "Name");
            ViewData["UserId"] = new SelectList(_context.Users, "UserId", "Email");
            string url = $"https://localhost:7178/api/UserFollowArtists/create";
        ...
        public async Task<IActionResult> Edit(Guid? id)
        {
            ViewData["ArtistId"] = new SelectList(_context.Artists, "ArtistId", "Name");
            ViewData["UserId"] = new SelectList(_context.Users, "UserId", "Email");
            string url = $"https://localhost:7178/api/UserFollowArtists/get-by-id?id={id}";
            var reponse = await _httpClient.GetStringAsync(url);
        ...
        {
            string url = $"https://localhost:7178/api/UserFollowArtists/update";
        ...
        {
            string url = $"https://localhost:7178/api/UserFollowArtists/delete?id={id}";
