...
namespace WuyiMusic.Areas.Admin.Controllers
{
    ...
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            string url = "https://localhost:7178/api/Notifications/get-all";
        ...
        {
            string url = $"https://localhost:7178/api/Notifications/get-by-id?id={id}";
            var reponse = await _httpClient.GetStringAsync(url);
        ...
        {
            ViewData["UserId"] = new SelectList(_context.Users, "UserId", "Username");
            string url = $"https://localhost:7178/api/Notifications/create";
        ...
        public async Task<IActionResult> Edit([Bind("NotificationId,UserId,Title,Message,CreatedAt,ReadAt")] Notification notification)
        {
            ...
            string url = $"https://localhost:7178/api/Notifications/update";
        ...
        {
            string url = $"https://localhost:7178/api/Notifications/delete?id={id}";
