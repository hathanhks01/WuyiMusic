...
namespace WuyiMusic.Areas.Admin.Controllers
{
    ...
    public class PlaylistsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            string url = "https://localhost:7178/api/Playlists/get-all";
        ...
        {
            string url = $"https://localhost:7178/api/Playlists/get-by-id?id={id}";
            var reponse = await _httpClient.GetStringAsync(url);
        ...
        {
            ViewData["UserId"] = new SelectList(_context.Users, "UserId", "Email");
            string url = $"https://localhost:7178/api/Playlists/create";
        ...
        public async Task<IActionResult> Edit(Guid? id)
        {
            ...
            string url = $"https://localhost:7178/api/Playlists/get-by-id?id={id}";
            var reponse = await _httpClient.GetStringAsync(url);
            var playlist = JsonConvert.DeserializeObject<Album>(reponse);
        ...
        {
            string url = $"https://localhost:7178/api/Playlists/update";
        ...
        {
            string url = $"https://localhost:7178/api/Playlists/delete?id={id}";
